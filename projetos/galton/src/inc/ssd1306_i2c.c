...
// void ssd1306_draw_circle(ssd1306_t *ssd, int xc, int yc, int r) {
//     int x = 0, y = r;
//     int d = 3 - 2 * r;

//     while (y >= x) {
//         ssd1306_set_pixel(ssd->ram_buffer + 1, xc + x, yc + y, true);
//         ssd1306_set_pixel(ssd->ram_buffer + 1, xc - x, yc + y, true);
//         ssd1306_set_pixel(ssd->ram_buffer + 1, xc + x, yc - y, true);
//         ssd1306_set_pixel(ssd->ram_buffer + 1, xc - x, yc - y, true);
//         ssd1306_set_pixel(ssd->ram_buffer + 1, xc + y, yc + x, true);
//         ssd1306_set_pixel(ssd->ram_buffer + 1, xc - y, yc + x, true);
//         ssd1306_set_pixel(ssd->ram_buffer + 1, xc + y, yc - x, true);
//         ssd1306_set_pixel(ssd->ram_buffer + 1, xc - y, yc - x, true);
//         x++;
...
//     memset(ssd->ram_buffer + 1, 0x00, ssd->bufsize - 1);
// }
